...
The script avoids averaging individual ticker percentages. Instead, it aggregates concurrent peak locked collateral relative to total year to date time elapsed:
